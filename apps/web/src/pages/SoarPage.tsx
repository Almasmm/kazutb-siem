...
import type { SOARApprovalDto, SOARConnectorDraftDto, SOARConnectorDto, SOARExecutionDto, SOARPlaybookDto } from "../api/types";
...
function connectorDraft(form: ConnectorForm): SOARConnectorDraftDto {
  ...
  if (form.kind === "NOTIFICATION_REST") {
    ...
    if (form.channel.trim()) settings.channel = form.channel.trim();
  }
