...
func NewRegistry(providers ...PublishedParserProvider) *Registry {
	registry := &Registry{
		parsers: map[string]ingest.EnvelopeParser{
			...
			ingest.FormatJournaldJSON:    JournaldJSON{},
		...
		descriptors: []Descriptor{
			...
			{ID: "linux-journald-json", Vendor: "Linux", Product: "systemd-journald", Version: "1.0.0", SchemaCompatibility: []string{"OCSF 1.4.0"}, Formats: []string{ingest.FormatJournaldJSON}, ReleaseState: "published"},
