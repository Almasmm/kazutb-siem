...
var fields = map[string]fieldDefinition{
	...
	"device.ip":               {"JSONExtractString(payload, 'device', 'ip')", "string"},
	"src_endpoint.ip":         {"src_ip", "string"},
	"dst_endpoint.ip":         {"dst_ip", "string"},
	"src_endpoint.hostname":   {"JSONExtractString(payload, 'src_endpoint', 'hostname')", "string"},
	"dst_endpoint.hostname":   {"JSONExtractString(payload, 'dst_endpoint', 'hostname')", "string"},
